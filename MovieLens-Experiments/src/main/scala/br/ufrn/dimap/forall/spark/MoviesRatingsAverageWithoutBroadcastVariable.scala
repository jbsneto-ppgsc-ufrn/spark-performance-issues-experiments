...
object MoviesRatingsAverageWithoutBroadcastVariable {
  ...
  def main(args: Array[String]) {
    ...
    conf.setAppName("MovieLens-Movies-Ratings-Average-Without-Broadcast-Variable")
    ...
    val resultsCVS = ratingsAverageSorted.map(x => x._1.toString + "," + movieNames(x._1).toString + "," + x._2.toString) // movieId,movieName,ratingAverage
